...
public final class GCM: BlockMode {
    ...
    public func worker(blockSize _: Int, cipherOperation: @escaping CipherOperationOnBlock, encryptionOperation _: @escaping CipherOperationOnBlock) throws -> CipherModeWorker {
        if iv.isEmpty {
