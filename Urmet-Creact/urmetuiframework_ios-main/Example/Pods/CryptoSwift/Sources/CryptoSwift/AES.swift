...
public final class AES: BlockCipher {
    ...
    //
    @usableFromInline
    internal lazy var expandedKey: [[UInt32]] = self.expandKey(self.key, variant: self.variant)

    @usableFromInline
    internal lazy var expandedKeyInv: [[UInt32]] = self.expandKeyInv(self.key, variant: self.variant)
