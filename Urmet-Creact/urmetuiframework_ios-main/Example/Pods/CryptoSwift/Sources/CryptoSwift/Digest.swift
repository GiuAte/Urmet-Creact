...
public enum Digest {
    ...
    /// - parameter bytes: input message
    /// - returns: Digest bytes
    public static func sha224(_ bytes: [UInt8]) -> [UInt8] {
        sha2(bytes, variant: .sha224)
    }
    ...
    /// - returns: Digest bytes
    public static func sha2(_ bytes: [UInt8], variant: SHA2.Variant) -> [UInt8] {
    ...
    /// - returns: Digest bytes
    public static func sha3(_ bytes: [UInt8], variant: SHA3.Variant) -> [UInt8] {
