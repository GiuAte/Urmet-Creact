...
public final class Checksum {
    ...
    @inlinable
    func crc32(_ message: [UInt8], seed: UInt32? = nil, reflect: Bool = true) -> UInt32 {
    ...
    @inlinable
    func crc32c(_ message: [UInt8], seed: UInt32? = nil, reflect: Bool = true) -> UInt32 {
        var crc: UInt32 = seed != nil ? seed! : 0xFFFF_FFFF
        for chunk in message.batched(by: 256) {
            for b in chunk {
                let idx = Int((crc ^ UInt32(reflect ? b : reversed(b))) & 0xFF)
    ...
    @inlinable
    func crc16(_ message: [UInt8], seed: UInt16? = nil) -> UInt16 {
...
public extension Checksum {
    ...
    @inlinable
    static func crc32(_ message: [UInt8], seed: UInt32? = nil, reflect: Bool = true) -> UInt32 {
    ...
    /// - returns: Calculated code
    @inlinable
    static func crc32c(_ message: [UInt8], seed: UInt32? = nil, reflect: Bool = true) -> UInt32 {
