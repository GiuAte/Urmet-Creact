...
extension AEAD {
    static func calculateAuthenticationTag(authenticator: Authenticator, cipherText: [UInt8], authenticationHeader: [UInt8]) throws -> [UInt8] {
        ...
        mac += [UInt8](repeating: 0, count: headerPadding)
        mac += cipherText
        mac += [UInt8](repeating: 0, count: cipherPadding)
