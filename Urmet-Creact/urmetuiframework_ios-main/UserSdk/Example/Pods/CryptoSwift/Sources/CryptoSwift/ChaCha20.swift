...
public final class ChaCha20: BlockCipher {
    ...
    fileprivate func core(block: inout [UInt8], counter: [UInt8], key: [UInt8]) {
        ...
        let j4 = UInt32(bytes: key[0 ..< 4]).bigEndian
        let j5 = UInt32(bytes: key[4 ..< 8]).bigEndian
        let j6 = UInt32(bytes: key[8 ..< 12]).bigEndian
        let j7 = UInt32(bytes: key[12 ..< 16]).bigEndian
        let j8 = UInt32(bytes: key[16 ..< 20]).bigEndian
        let j9 = UInt32(bytes: key[20 ..< 24]).bigEndian
        let j10 = UInt32(bytes: key[24 ..< 28]).bigEndian
        let j11 = UInt32(bytes: key[28 ..< 32]).bigEndian
        let j12 = UInt32(bytes: counter[0 ..< 4]).bigEndian
        let j13 = UInt32(bytes: counter[4 ..< 8]).bigEndian
        let j14 = UInt32(bytes: counter[8 ..< 12]).bigEndian
        let j15 = UInt32(bytes: counter[12 ..< 16]).bigEndian
...
extension ChaCha20: Cipher {
    public func encrypt(_ bytes: ArraySlice<UInt8>) throws -> [UInt8] {
        process(bytes: bytes, counter: &counter, key: Array(key))
    }
...
public extension ChaCha20 {
    struct ChaChaEncryptor: Cryptor, Updatable {
...
public extension ChaCha20 {
    struct ChaChaDecryptor: Cryptor, Updatable {
        private var accumulated = [UInt8]()
