//
//  IpercomGetDevicseMessageFactory.swift
//  CallMeSdk
//
...
final class IpercomGetDevicesMessageFactory: DeviceMessageFactory {
    private static let type = "get_available_devices_req"
